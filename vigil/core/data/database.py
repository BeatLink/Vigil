...
class InternalDatabaseLogger:
    """Abstraction layer for plugins to write logs and metrics without touching the ORM directly."""
    ...
    def write(self, message: str, level: str = "INFO"):
        ...
        self.db.insert_event(level=level, message=message, target=self.target)
...
__all__ = ['VigilDatabase', 'Metric', 'Event', 'Setting', 'InternalDatabaseLogger']