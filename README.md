...
- **Notifications**: Notifies you when a monitor starts failing, keeps failing or recovers, with per-monitor rules. Sends to the desktop through the agent, to your phone through ntfy, or to any webhook, and each notification links straight to the monitor's page. See [docs/notifications.md](docs/notifications.md).
