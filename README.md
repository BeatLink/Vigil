...
- **Notifications**: Notifies you when a monitor starts failing, keeps failing or recovers, with per-monitor rules. Desktop notifications, shown by the agent, link straight to the monitor's page. More channels are planned; see [docs/notifications.md](docs/notifications.md).
